class Activity < ApplicationRecord
  ...
  ACTIONS = {
    ...
    "domain.ssl_enabled" => "enabled SSL on",
    "ssh_key.added" => "added SSH key",
    "ssh_key.removed" => "removed SSH key",
    "billing.deposit" => "deposited to wallet",
    "billing.daily_debit" => "billed daily usage",
    "billing.app_suspended" => "suspended apps (low balance)",
    "billing.app_resumed" => "resumed apps",
